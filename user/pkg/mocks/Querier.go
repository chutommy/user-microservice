...
func (_m *Querier) GetUserByUsername(ctx context.Context, username sql.NullString) (repo.User, error) {
	ret := _m.Called(ctx, username)

	var r0 repo.User
	if rf, ok := ret.Get(0).(func(context.Context, sql.NullString) repo.User); ok {
		r0 = rf(ctx, username)
	} else {
		r0 = ret.Get(0).(repo.User)
	}
...
// UpdateUserUsername provides a mock function with given fields: ctx, arg
func (_m *Querier) UpdateUserUsername(ctx context.Context, arg repo.UpdateUserUsernameParams) (repo.User, error) {
	ret := _m.Called(ctx, arg)

	var r0 repo.User
	if rf, ok := ret.Get(0).(func(context.Context, repo.UpdateUserUsernameParams) repo.User); ok {
		r0 = rf(ctx, arg)
	} else {
		r0 = ret.Get(0).(repo.User)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, repo.UpdateUserUsernameParams) error); ok {
		r1 = rf(ctx, arg)
	} else {
		r1 = ret.Error(1)
	}
