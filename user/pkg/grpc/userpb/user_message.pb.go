...
type User struct {
	...
	// process or if it needs to be updated. Otherwisem this field
	// is always empty.
	...
	Birthday  *User_Date  `protobuf:"bytes,8,opt,name=birthday,proto3" json:"birthday,omitempty"`
}
...
func (x *User) GetBirthday() *User_Date {
	if x != nil {
		return x.Birthday
	}
	return nil
...
// Representation can be following:
//
// * A full date (birthday)
// * A zero-year, month-day value (anniversary)
// * A zero-day, year-month value (expiration)
// * A year only, zero month and day (birth year)
type User_Date struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *User_Date) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*User_Date) ProtoMessage() {}

func (x *User_Date) ProtoReflect() protoreflect.Message {
	mi := &file_user_message_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use User_Date.ProtoReflect.Descriptor instead.
func (*User_Date) Descriptor() ([]byte, []int) {
	return file_user_message_proto_rawDescGZIP(), []int{0, 0}
}

func (x *User_Date) GetYear() int32 {
	if x != nil {
		return x.Year
	}
	return 0
...
func (x *User_Date) GetMonth() int32 {
	if x != nil {
		return x.Month
	}
	return 0
...
var file_user_message_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0xee, 0x02, 0x0a, 0x04, 0x55,
	...
	0x65, 0x72, 0x12, 0x2b, 0x0a, 0x08, 0x62, 0x69, 0x72, 0x74, 0x68, 0x64, 0x61, 0x79, 0x18, 0x08,
	...
	0x64, 0x61, 0x79, 0x22, 0x36, 0x0a, 0x06, 0x47, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x12, 0x0b, 0x0a,
	...
	0x12, 0x09, 0x0a, 0x05, 0x4f, 0x54, 0x48, 0x45, 0x52, 0x10, 0x03, 0x42, 0x43, 0x5a, 0x41, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x68, 0x75, 0x74, 0x69, 0x66,
	0x69, 0x65, 0x64, 0x2f, 0x62, 0x6f, 0x6f, 0x6b, 0x69, 0x6e, 0x67, 0x2d, 0x74, 0x65, 0x72, 0x6d,
	0x69, 0x6e, 0x61, 0x6c, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x67, 0x72,
	0x70, 0x63, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x70, 0x62, 0x3b, 0x75, 0x73, 0x65, 0x72, 0x70, 0x62,
